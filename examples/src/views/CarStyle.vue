<template>
  <div class="map-container">
    <div id="bitmap"></div>
    <div id="park"><el-alert title="这是车位弹窗" type="success" center show-icon></el-alert></div>
    <div id="car"><el-alert title="这是小汽车弹窗" type="warning" center show-icon></el-alert></div>
    <div id="mark"><el-alert title="这是欠费标志弹窗" type="error" center show-icon></el-alert></div>
  </div>
</template>
