...
function commonConfig() {
  ...
  var getFeatureStyle = function getFeatureStyle(markerInfo, styleObj) {
    ...
    var rotation = styleObj && styleObj.rotation ? styleObj.rotation : 0;
    var rotateWithView = styleObj && styleObj.rotateWithView ? styleObj.rotateWithView : false;
    var snapToPixel = styleObj && styleObj.snapToPixel ? styleObj.snapToPixel : true;
    return new ol.style.Style({
...
HDMap.prototype.addBgLayer = function (markerInfo) {
  ...
  var iconBgFeature = new ol.CountFeature({
    geometry: new ol.geom.Point([markerInfo.position[0] + 3, markerInfo.position[1]])
  }, markerInfo, layerKey);
...
function getFeaturesInExtent(map, coordinate) {
  ...
  // 设置区域范围
  var extent = [coordinate[0] - distance, coordinate[1] - distance, coordinate[0] + distance, coordinate[1] + distance];
...
=======
  getFeaturesInExtent: getFeaturesInExtent
>>>>>>> 0f0a90b96624c7bde243edf777cca6c46c13a8e5
};
