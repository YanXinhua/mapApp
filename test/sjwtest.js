...
export const sjw = function () {
  ...
  btn2.onclick = function () {
    ...
    var pointC = [mcenter[0] + pointC[0], mcenter[1] + pointC[1]];
    var pointB = [mcenter[0] + pointB[0], mcenter[1] + pointB[1]];
  ...
  btn3.onclick = function () {
    ...
    var lonlat = [lon, lat];
    console.log(lonlat);
    center = document.getElementById('input3').value = lonlat;
